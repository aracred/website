...
The benefit of using Aragon Fundraising is that you have a true [DAICO](https://ethresear.ch/t/explanation-of-daicos/465) model. People can buy your project's token, then use it within the context of your project. As they do, some of the funds from the collateral pool of the token market can be allocated to support the maintenance of the project itself. This way people creating a project have the incentives and support required to make the tokens valuable and in high demand, and the people who want those tokens always have a market from which they can buy tokens. 
