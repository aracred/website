---
id: automatedDeploymentOverview
title: AraCred Automated Deployment (beta)
sidebar_label: AraCred Automated Deployment
---
...
> This is how to deploy your own AraCred instance, the easy way. 
...
# Step 1: Creating your AraCred instance

<Tabs
  defaultValue="setup"
  values={[
    { label: 'Setup your own AraCred', value: 'setup', },
    ...
    <TabItem value="setup">
        <p>Open a terminal and execute <code>npx aracred-init</code></p>
        <p>You will be asked for the following parameters:</p>
        <ul>
            <li>Address of the DAO to be used</li>
            <li>Address of the Token Manager app instance</li>
            <li>Address of the Voting app instance</li>
            <li>Discord Server name</li>
            <li>Discord Server ID</li>
            <li>GitHub access token</li>
        </ul>
        <p>This will generate a new Git repo. You can create a new repo on GitHub, and then push to it by executing:</p>
        <code>git remote add origin git@github.com:User/UserRepo</code>
...
<Tabs
  ...
  values={[
    ...
    <TabItem value="view-cred-graph">
        <img alt="View Cred Graph" src={useBaseUrl('img/view-cred-graph.png')} />
    </TabItem>
...
# Step 6: See your tokens being minted
